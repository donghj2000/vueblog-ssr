...
export default defineComponent({
    ...
    asyncData({ store, route }) {
        console.log("ArticleDetail,asyncData,(store,route) id=", route._value.query.id);
        return store.dispatch('getArticleList', route._value.query.id).then(function () {})
    },
    setup() {
        ...
        onMounted(()=> {
            if (state.detail.id != undefined || state.detail.id != null) {
                return;
            }
